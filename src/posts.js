...
export const recommendedPosts = [
  {
    id: 30,
    title: "Angular",
    body: `Learn one way to build applications with Angular and reuse your code and abilities to build apps for any deployment target.
  ...
  },
  {
    id: 32,
    title: "Backbone.js",
    body: `Backbone.js gives structure to web applications by providing models with key-value binding and custom events,
